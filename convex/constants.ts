...
// Wait for 10s for another player to say something before jumping in.
...
export const ACTIVITIES = [
  { description: '책 읽는 중···', emoji: '📖', duration: 20_000 },
  { description: '고민 중···', emoji: '🤔', duration: 20_000 },
  { description: '정원 가꾸는 중···', emoji: '🥕', duration: 20_000 },
  { description: '코딩 중···', emoji: '💻', duration: 20_000 },
  { description: '요리하는 중···', emoji: '🍳', duration: 15_000 },
  { description: '운동하는 중···', emoji: '🏋', duration: 20_000 }
];
